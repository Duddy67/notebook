...
JHtml::_('formbehavior.chosen', '.multipleUsers',null,array('placeholder_text_multiple' => JText::_('COM_NOTEBOOK_OPTION_SELECT_USER')));
...
$canOrder = $user->authorise('core.edit.state', 'com_notebook.category');
$saveOrder = $listOrder == 'n.ordering';

if($saveOrder) {
  $saveOrderingUrl = 'index.php?option=com_notebook&task=notes.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_notebook&view=notes');?>" method="post" name="adminForm" id="adminForm">
...
?>
  ...
  <?php else : ?>
	...
	<?php echo JHtml::_('searchtools.sort', 'JGRID_HEADING_ID', 'n.id', $listDirn, $listOrder); ?>
      ...
      $canCreate = $user->authorise('core.create', 'com_notebook.category.'.$item->catid);
	...
	<td class="order nowrap center hidden-phone">
	  ...
	  <td class="has-context">
		...
		<a href="<?php echo JRoute::_('index.php?option=com_notebook&task=note.edit&id='.$item->id);?>" title="<?php echo JText::_('JACTION_EDIT'); ?>"><?php echo $this->escape($item->title); ?></a>
	      <?php else : ?>
...
<input type="hidden" name="option" value="com_notebook" />
