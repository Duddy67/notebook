  ...
  <fieldset class="filter clearfix">
    <div class="btn-toolbar">
      ...
      <div class="btn-group pull-left">
	      ...
	      title="<?php echo JText::_('COM_NOTEBOOK_FILTER_SEARCH_DESC'); ?>" />
      </div>
      <div class="btn-group pull-left">
	...
	<?php echo JHtml::_('select.options', JHtml::_('category.options', 'com_notebook', array('filter.language' => array('*', $this->state->get('filter.forcedLanguage')))), 'value', 'text', $this->state->get('filter.category_id'));?>
      </select>
      ...
      <select name="filter_category_id" class="input-medium" onchange="this.form.submit()">
	<option value=""><?php echo JText::_('JOPTION_SELECT_CATEGORY');?></option>
	<?php echo JHtml::_('select.options', JHtml::_('category.options', 'com_notebook'), 'value', 'text', $this->state->get('filter.category_id'));?>
      </select>
      <select name="filter_tag" class="input-medium" onchange="this.form.submit()">
	<option value=""><?php echo JText::_('JOPTION_SELECT_TAG');?></option>
	<?php echo JHtml::_('select.options', JHtml::_('tag.options', 'com_notebook'), 'value', 'text', $this->state->get('filter.tag'));?>
      </select>
