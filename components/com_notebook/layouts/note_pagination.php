...
?>
   ...
   <ul>
	...
	<a href="#" title="<?php echo JText::_('JLIB_HTML_START'); ?>" onclick="document.siteForm.limitstart.value=0; notebook.submitForm(); return false;">
	    <?php echo JText::_('JLIB_HTML_START'); ?></a>
      </li>
      <li class="pagination-prev">
	<a href="#" title="<?php echo JText::_('JPREV'); ?>" onclick="document.siteForm.limitstart.value=<?php echo $prev; ?>; notebook.submitForm(); return false;"><?php echo JText::_('JPREV'); ?></a>
      </li>
   <?php else : ?>
      <li class="pagination-start">
   ...
   <?php for($i = 0; $i < $pagination['pages.total']; $i++) :
	   ...
	   if($page != $pagination['pages.current']) : ?>
	     <li><a href="#" title="<?php echo $page; ?>" onclick="document.siteForm.limitstart.value=<?php echo $limitStart; ?>;
							  notebook.submitForm(); return false;"> <?php echo $page ?></a></li>
       <?php else : ?>
   ...
   <?php if($pagination['pages.current'] < $pagination['pages.stop']) : 
	   ...
	   <li class="pagination-next">
	     <a href="#" title="<?php echo JText::_('JNEXT'); ?>" onclick="document.siteForm.limitstart.value=<?php echo $nextLimitStart; ?>;
						      notebook.submitForm(); return false;"><?php echo JText::_('JNEXT'); ?></a>
	   </li>
	   <li class="pagination-end">
	     <a href="#" title="<?php echo JText::_('JLIB_HTML_END'); ?>" onclick="document.siteForm.limitstart.value=<?php echo $limitStart; ?>;
						     notebook.submitForm(); return false;"><?php echo JText::_('JLIB_HTML_END'); ?></a>
	   </li>
   <?php else : ?>
	   <li class="pagination-next">
