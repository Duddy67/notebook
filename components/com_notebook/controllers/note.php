...
class NotebookControllerNote extends JControllerForm
{
  ...
  protected function allowAdd($data = array())
  {
    ...
    if($categoryId) {
      ...
      $allow = $user->authorise('core.create', 'com_notebook.category.'.$categoryId);
    }
  ...
  protected function allowEdit($data = array(), $key = 'id')
  {
    ...
    $user = JFactory::getUser();
    $userId = $user->get('id');
    $asset = 'com_notebook.note.'.$recordId;
   ...
   * @since   1.6
   */
  public function cancel($key = 'n_id')
  {
    parent::cancel($key);
   ...
   * @since   1.6
   */
  public function edit($key = null, $urlVar = 'n_id')
  {
   ...
   * @since   1.6
   */
  protected function getRedirectToItemAppend($recordId = null, $urlVar = 'n_id')
  {
   ...
   * @since   1.6
   */
  public function save($key = null, $urlVar = 'n_id')
  {
